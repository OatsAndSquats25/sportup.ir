...
urlpatterns = patterns('',
    url(r'^$', checkout.as_view(), name='checkoutURL'),
    url(r'^pay/$', checkout.as_view(), {'command':'pay'}, name='checkoutPayURL'),
    url(r'^deleteitem/(?P<pk>\d+)/$', fianceDeleteItem.as_view(), name='checkoutDeleteItem'),
