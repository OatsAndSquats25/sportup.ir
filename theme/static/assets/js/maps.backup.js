var mapStyles = [ {"featureType":"road","elementType":"labels","stylers":[{"visibility":"simplified"},{"lightness":20}]},{"featureType":"administrative.land_parcel","elementType":"all","stylers":[{"visibility":"off"}]},{"featureType":"landscape.man_made","elementType":"all","stylers":[{"visibility":"on"}]},{"featureType":"transit","elementType":"all","stylers":[{"saturation":-100},{"visibility":"on"},{"lightness":10}]},{"featureType":"road.local","elementType":"all","stylers":[{"visibility":"on"}]},{"featureType":"road.local","elementType":"all","stylers":[{"visibility":"on"}]},{"featureType":"road.highway","elementType":"labels","stylers":[{"visibility":"simplified"}]},{"featureType":"poi","elementType":"labels","stylers":[{"visibility":"off"}]},{"featureType":"road.arterial","elementType":"labels","stylers":[{"visibility":"on"},{"lightness":50}]},{"featureType":"water","elementType":"all","stylers":[{"hue":"#a1cdfc"},{"saturation":30},{"lightness":49}]},{"featureType":"road.highway","elementType":"geometry"
,"stylers":[{"hue":"#f49935"}]},{"featureType":"road.arterial","elementType":"geometry","stylers":[{"hue":"#fad959"}]}, {featureType:'road.highway',elementType:'all',stylers:[{hue:'#dddbd7'},{saturation:-92},{lightness:60},{visibility:'on'}]}, {featureType:'landscape.natural',elementType:'all',stylers:[{hue:'#c8c6c3'},{saturation:-71},{lightness:-18},{visibility:'on'}]},  {featureType:'poi',elementType:'all',stylers:[{hue:'#d9d5cd'},{saturation:-70},{lightness:20},{visibility:'on'}]} ];
            ...
            '<div class="inner">' +
                '<div class="image">' +
                    ...
                    '<div class="item-specific">' +
                        '<span title="Bedrooms"><img src="/static/assets/img/bedrooms.png">' + json.data[i].bedrooms + '</span>' +
                        '<span title="Bathrooms"><img src="/static/assets/img/bathrooms.png">' + json.data[i].bathrooms + '</span>' +
                        '<span title="Area"><img src="/static/assets/img/area.png">' + json.data[i].area + '<sup>2</sup></span>' +
                        '<span title="Garages"><img src="/static/assets/img/garages.png">' + json.data[i].garages + '</span>' +
                    '</div>' +
                    '<div class="overlay">' +
                        '<div class="wrapper">' +
    ...
    function drawItemSpecific(category){
        if( category ){
            if( category == 'real_estate' ){
                var itemSpecific =
                '<div class="item-specific">' +
                    '<span title="Bedrooms"><img src="/static/assets/img/bedrooms.png">' + json.data[a].bedrooms + '</span>' +
                    '<span title="Bathrooms"><img src="/static/assets/img/bathrooms.png">' + json.data[a].bathrooms + '</span>' +
                    '<span title="Area"><img src="/static/assets/img/area.png">' + json.data[a].area + '<sup>2</sup></span>' +
                    '<span title="Garages"><img src="/static/assets/img/garages.png">' + json.data[a].garages + '</span>' +
                '</div>';
                return itemSpecific;
            }
            else if ( category == 'bar_restaurant' ){
            ...
            '<div class="modal-dialog">' +
                '<div class="modal-content">' +
                    '<div class="modal-header">' +
                        '<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true"><img src="/static/assets/img/close.png"></span></button>' +
                        '<div class="left">' +
